...
async def get_system_info():
    ...
    #Pi-Hole Website (as below), Settings, API/Web interface, Show API Token, paste over YOURTOKENGOESHERE
    url = "http://0.0.0.0:{}/admin/api.php?auth=<YOURTOKENGOESHERE>".format(PIHOLE_PORT) 
